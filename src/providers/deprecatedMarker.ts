...
/**
 * Scans open editor content and decorates macros marked as deprecated in the
 * macro definitions with a highlight and trailing label.
 */
export function activateDeprecatedMarker(context: vscode.ExtensionContext) {
